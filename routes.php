...
$route['viewinvoice/(:any)/(:any)']  = "clients/viewinvoice/$1/$2";
...
$route['admin/departments/manage/main']  = "admin/depts";
$route['admin/departments/manage/sub']   = "admin/depts/sub";
$route['admin/departments/manage/child'] = "admin/depts/child";
