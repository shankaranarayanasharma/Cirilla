...
import 'package:cirilla/screens/post_category/post_category.dart';
...
class TabsProList extends StatefulWidget {
...
class _TabsState extends State<TabsProList> with Utility {
  int _currentIndex = 0;
  int fixedIndex = 0;
  bool active = false;
  @override
  Widget build(BuildContext context) {
    ...
    _onTap(int index) {
      ...
      if(_currentIndex==0)
      {
        screen_name = 'screens_home';
      }
      else if(_currentIndex==1)
      {
        screen_name = 'screens_category';
      }
      else if(_currentIndex==2)
      {
        screen_name = 'screens_wishlist';
      }
      else if(_currentIndex==3)
      {
        screen_name = 'screens_cart';
      }
      else if(_currentIndex==4)
      {
        screen_name = 'screens_profile';
      }
      else
      {
        screen_name = 'screens_home';
      ...
      active = true;
      widget.onItemTapped!(
          NavigationMixin().navigate(context, {
            'type': 'tab',
            'route': '/',
            'args': {'key': screen_name}
          })
      );
    }
