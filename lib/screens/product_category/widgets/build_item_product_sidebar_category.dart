...
///
class BuildItemProductSidebarCategory extends StatefulWidget {
  ...
  const BuildItemProductSidebarCategory({
    Key? key,
  ...
  @override
  _BuildItemProductSidebarCategoryState createState() => _BuildItemProductSidebarCategoryState();
}

class _BuildItemProductSidebarCategoryState extends State<BuildItemProductSidebarCategory> with CategoryMixin {
  ...
  Widget buildItem(BuildContext context) {
    ...
    switch (typeTemplate) {
      ...
      // bool enableSubcategories = get(dataTemplate, ['enableSubcategories'], true);
        ...
        return Container(
          child: ProductCategoryContainedItem(
            image: enableImage
                ? buildImage(
              category: widget.category!,
              width: sizeImage-150,
              height: sizeImage-150,
              radius: radiusImage,
