...
import 'build_item_product_sidebar_category.dart';
import 'list_category.dart';

class ListCategorySidebarScrollLoadMore extends ListCategory {
  const ListCategorySidebarScrollLoadMore({
    Key? key,
              ...
              return Container(
                ...
                child: LayoutBuilder(
                  builder: (_, BoxConstraints constraints) {
                    ProductCategory category = categories[index]!;
                    double width = constraints.maxWidth;
                    return BuildItemProductSidebarCategory(
                      category: category,
                      textName: category.id == idShowAll && enableTextShowAll! ? textShowAll : null,
                      template: template,
                      styles: styles,
