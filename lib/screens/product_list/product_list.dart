...
import 'package:cirilla/screens/home/widgets/tabs.dart';
import 'package:cirilla/screens/home/widgets/tabs_product_list.dart';
...
class _ProductListScreenState extends State<ProductListScreen>
  ...
  Widget build(BuildContext context) {
    // Configs
    Data data = widget.store!.data!.screens!['products']!;
    Data? tabsData = widget.store!.data!.settings!['tabs'];
    ...
    return Observer(
      builder: (_) {
        ...
        return Scaffold(
          key: _scaffoldKey,
            bottomNavigationBar: TabsProList(
              selected: 'screens_category',
