...
import 'package:cirilla/screens/product_category/widgets/body_default.dart';
import 'package:cirilla/screens/product_category/widgets/body_horizontal.dart';
import 'package:cirilla/screens/product_category/widgets/body_vertical.dart';
import 'package:cirilla/screens/product_category/widgets/body_vertical_sidebar.dart';
...
class _RefineState extends State<Refine> with CategoryMixin, LoadingMixin, CategoryMixin {
  ...
  void didChangeDependencies() {
    ...
    if (!_productCategoryStore.loading && _productCategoryStore.categories.isEmpty) {
      _productCategoryStore.getCategories();
    }
    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, controller) {
        return Observer(builder: (_) {
          ...
          ThemeData theme1 = Theme.of(context);
          return Stack(
            children: [
