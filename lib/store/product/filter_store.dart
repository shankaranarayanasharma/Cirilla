...
abstract class _FilterStore with Store {
  ...
  Future getAttributes(
      {Map<String, dynamic>? queryParameters, bool updateStore = true}) async {
  ...
  Future<void> getMinMaxPrices(
      {ProductCategory? category, bool updateStore = true}) async {
    try {
      ProductPrices prices = await _requestHelper
          .getMinMaxPrices(queryParameters: {'category': _category?.id ?? ''});
