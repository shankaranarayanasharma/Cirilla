...
mixin _$ProductRecentlyStore on _ProductRecentlyStore, Store {
  ...
  bool exist(String value) {
    final _$actionInfo = _$_ProductRecentlyStoreActionController.startAction(name: '_ProductRecentlyStore.exist');
    try {
      return super.exist(value);
    } finally {
      _$_ProductRecentlyStoreActionController.endAction(_$actionInfo);
    }
  }
