...
mixin _$VendorStore on _VendorStore, Store {
  ...
  bool get loading => (_$loadingComputed ??=
          Computed<bool>(() => super.loading, name: '_VendorStore.loading'))
      .value;
  Computed<ObservableList<Vendor>>? _$vendorsComputed;

  @override
  ObservableList<Vendor> get vendors => (_$vendorsComputed ??=
          Computed<ObservableList<Vendor>>(() => super.vendors,
              name: '_VendorStore.vendors'))
      .value;
  Computed<ObservableList<int>>? _$categoryVendorsComputed;

  @override
  ObservableList<int> get categoryVendors => (_$categoryVendorsComputed ??=
          Computed<ObservableList<int>>(() => super.categoryVendors,
              name: '_VendorStore.categoryVendors'))
      .value;
  ...
  bool get canLoadMore =>
      (_$canLoadMoreComputed ??= Computed<bool>(() => super.canLoadMore,
              name: '_VendorStore.canLoadMore'))
          .value;
  Computed<int>? _$perPageComputed;

  @override
  int get perPage => (_$perPageComputed ??=
          Computed<int>(() => super.perPage, name: '_VendorStore.perPage'))
      .value;
  Computed<String>? _$langComputed;

  @override
  String get lang => (_$langComputed ??=
          Computed<String>(() => super.lang, name: '_VendorStore.lang'))
      .value;
  Computed<String?>? _$searchComputed;

  @override
  String? get search => (_$searchComputed ??=
          Computed<String?>(() => super.search, name: '_VendorStore.search'))
      .value;
  Computed<ProductCategory?>? _$categoryComputed;

  @override
  ProductCategory? get category =>
      (_$categoryComputed ??= Computed<ProductCategory?>(() => super.category,
              name: '_VendorStore.category'))
          .value;
  ...
  Map<dynamic, dynamic> get sort =>
      (_$sortComputed ??= Computed<Map<dynamic, dynamic>>(() => super.sort,
              name: '_VendorStore.sort'))
          .value;
  Computed<double>? _$rangDistanceComputed;

  @override
  double get rangDistance =>
      (_$rangDistanceComputed ??= Computed<double>(() => super.rangDistance,
              name: '_VendorStore.rangDistance'))
          .value;

  final _$fetchVendorsFutureAtom =
      Atom(name: '_VendorStore.fetchVendorsFuture');
  ...
  @override
  Future<void> refresh() {
    final _$actionInfo = _$_VendorStoreActionController.startAction(
        name: '_VendorStore.refresh');
    try {
