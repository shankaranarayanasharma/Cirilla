...
mixin _$PostStore on _PostStore, Store {
  ...
  @override
  String get postType => (_$postTypeComputed ??=
          Computed<String>(() => super.postType, name: '_PostStore.postType'))
      .value;
  ...
  PostCategoryStore? get postCategoryStore => (_$postCategoryStoreComputed ??=
          Computed<PostCategoryStore?>(() => super.postCategoryStore,
              name: '_PostStore.postCategoryStore'))
      .value;
  ...
  int get nextPage => (_$nextPageComputed ??=
          Computed<int>(() => super.nextPage, name: '_PostStore.nextPage'))
      .value;
  ...
  Map<dynamic, dynamic> get sort =>
      (_$sortComputed ??= Computed<Map<dynamic, dynamic>>(() => super.sort,
              name: '_PostStore.sort'))
          .value;
  Computed<int>? _$perPageComputed;

  @override
  int get perPage => (_$perPageComputed ??=
          Computed<int>(() => super.perPage, name: '_PostStore.perPage'))
      .value;
  ...
  final _$_excludeAtom = Atom(name: '_PostStore._exclude');
  ...
  void onChanged(
      ...
      bool silent = false}) {
    final _$actionInfo =
        _$_PostStoreActionController.startAction(name: '_PostStore.onChanged');
    try {
