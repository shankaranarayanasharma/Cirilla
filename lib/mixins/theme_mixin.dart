...
class ThemeMixin {
  ...
  ThemeData buildTheme(SettingStore store) {
    ...
    SystemUiOverlayStyle _light = brightnessLight == 1 ? SystemUiOverlayStyle.dark : SystemUiOverlayStyle.light;
    SystemUiOverlayStyle _dark = brightnessDark == 0 ? SystemUiOverlayStyle.light : SystemUiOverlayStyle.dark;
    ...
    return base.copyWith(
      ...
      appBarTheme: AppBarTheme(
        ...
        systemOverlayStyle: store.darkMode ? _dark : _light,
        titleTextStyle:
